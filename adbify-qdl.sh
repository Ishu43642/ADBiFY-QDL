...
return_to_menu() {
    ...
    if [[ "$choice" == "y" || "$choice" == "Y" || "$choice" == "yes" || "$choice" == "YES" ]]; then
        ...
        echo -e "\033[1;32m✓ Exiting program. Thank you for using ADBify QDL Tool! \033[0m"
	echo -e "\033[1;33m╭───────────────────────────────────────────────╮\033[0m"
...
echo -e "\033[1;36m
╔═══════════════════════════════════════════════╗
║\033[1;33m     ★ \033[1;37m ADBify QDL  Tool By Repair-A2Z\033[1;33m ★\033[1;36m       ║
║\033[1;33m      ★ \033[1;37mSpecial Thanks To @RohitVerma \033[1;33m ★\033[1;36m       ║
╠═══════════════════════════════════════════════╣
...
echo -e "\033[1;34m│ \033[1;37m 3. \033[1;92m🔍 Check Fastboot Device                 \033[1;34m│\033[0m"
...
echo -e "\033[0;32m Please enter the patch file location. \033[0m";
  ...
  "3")
    ...
    echo -e "\033[1;92m► Searching 🔍Fastboot Devices... \033[0m"
    fastboot devices
